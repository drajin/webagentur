                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-7 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".4s">Sie brauchen eine neue Internetseite?</h1><br><h2><strong> Dann sind Sie hier richtig!</strong></h2>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="section-tittle text-center">
                        <h2>Was wir tun  <br> <small>Unser Service im  Überblick</small>
                        </h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-do text-center mb-30">
                        ...
                        <div class="do-caption">
                            <h4>WEBDESIGN</h4>
                            <p>Wir entwickeln nach Ihren Vorgaben und Anforderungen Ihre individuelle Webseite. </p>
                        </div>
                        <div class="do-btn">
                            <a href="#"><i class="ti-arrow-right"></i> Weitere Infos</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-do active text-center mb-30">
                        ...
                        <div class="do-caption">
                            <h4>WEB APPS</h4>
                            <p>In der modernen Zeit lässt sich fast alles über Web Applikationen steuern.</p>
                        </div>
                        <div class="do-btn">
                            <a href="#"><i class="ti-arrow-right"></i> Weitere Infos</a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-do text-center mb-30">
                        ...
                        <div class="do-caption">
                            <h4>WEB MARKETING</h4>
                            <p>Unsere Agentur bietet Ihnen professionelle Suchmaschinenoptimierung an.</p>
                        </div>
                        <div class="do-btn">
                            <a href="#"><i class="ti-arrow-right"></i> Weitere Infos</a>
                        </div>
