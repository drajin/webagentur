...
<html class="no-js" lang="zxx">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.blade.php"><img src="public/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center" data-background="public/img/hero/h1_hero.png">
                    <div class="container">
                ...
                <div class="row d-flex align-items-end">
                    <div class="col-lg-6 col-md-12">
                        <div class="we-create-img">
                            <img src="public/img//service/we-create.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
            ...
            <div class="container-fluid p-0">
                <div class="row ">
                    <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            <div class="visited-img">
                                <img src="public/img/visit/visit_1.jpg" alt="">
                            </div>
                     ...
                     <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            <div class="visited-img">
                                <img src="public/img/visit/visit_2.jpg" alt="">
                            </div>
                            <div class="visited-cap">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            <div class="visited-img">
                                <img src="public/img/visit/visit_3.jpg" alt="">
                            </div>
                            <div class="visited-cap">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            <div class="visited-img">
                                <img src="public/img/visit/visit_4.jpg" alt="">
                            </div>
                            <div class="visited-cap">
                                        ...
                                        <div class="testimonial-caption ">
                                            ...
                                            <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                                <div class="founder-img">
                                                    <img src="public/img/testmonial/testimonial.png" alt="">
                                                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-tips mb-50">
                            <div class="tips-img">
                                <img src="public/img/tips/tips_1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-tips mb-50">
                            <div class="tips-img">
                                <img src="public/img/tips/tips_2.jpg" alt="">
                            </div>
                            <div class="tips-caption">
                                <h4><a href="#">Twice profit than before you ever got</a></h4>
                                <span>Continue Reading</span>
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-tips mb-50">
                            <div class="tips-img">
                                <img src="public/img/tips/tips_3.jpg" alt="">
                            </div>
                            <div class="tips-caption">
                                <h4><a href="#">Twice profit than before you ever got</a></h4>
                                <span>Continue Reading</span>
        ...
        <!-- Tips Triks End -->
         ...
         <div class="have-project">
            <div class="container">
                <div class="haveAproject"  data-background="public/img/team/have.jpg">
                    <div class="row d-flex align-items-center">
   ...
   <footer>
       ...
       <!-- Footer Start-->
      <div class="footer-main" data-background="public/img/shape/footer_bg.png">
                       ...
                       <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo">
                                 <a href="index.blade.php"><img src="public/img/logo/logo2_footer.png" alt=""></a>
                             </div>
