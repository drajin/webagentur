...
{{--    </div>--}}
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.blade.php"><img src="assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="blog/blog.blade.php">Blog</a>
                                            <ul class="submenu">
                                                <li><a href="blog/blog.blade.php">Blog</a></li>
                                                <li><a href="blog/show.blade.php">Blog Details</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Pages</a>
                                            <ul class="submenu">
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Liebe Besucher!</h2>
                        <p>Webagentur ist eine Agentur mit dem Sitz im Herzen von Hannover. Wir bemühen uns Ihre Anliegen so schnell wie möglich zu beantworten. Bei uns  ist der Kunde König. Aus diesem Grund garantieren wir eine zufriedene Zusammenarbeit. Bei Fragen können Sie sehr gerne das Kontaktformular nutzen.</p>
                    </div>
                    <div class="col-lg-8">
{{--ffffff--}}
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ihre Nachricht'" placeholder="Ihre Nachricht"></textarea>
                                        @error('message')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ihr Name'" placeholder="Ihr Name">
                                        @error('name')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Hannover, Niedersachsen</h3>
                                <p>Bahnhofstraße , 30159</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>Montag bis Freitag zwischen 08 – 18 Uhr</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>support@webagentur.com</h3>
